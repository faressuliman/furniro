        ...
        <div className="flex gap-3 lg:gap-12">
          ...
          <div className="flex-1">
            ...
            {isLoading || categoryProductsLoading ? (
              <div className="lg:w-11/12 w-full products-grid grid grid-cols-2 gap-x-4 gap-y-8 sm:gap-x-6 md:grid-cols-3 md:gap-8 lg:gap-x-5 lg:gap-y-8 xl:gap-y-8 lg:border lg:border-gray-200 lg:rounded-lg lg:p-8 justify-items-center">
